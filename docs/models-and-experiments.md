...
specificity, ROC curves, and AUC. Source: `notebooks/final/fraud-detection-analysis.ipynb`, cells 51-60
and 63-66.
...
resolves, the discrepancy. Sources: `report/master-thesis-es.pdf`, p. 36;
`notebooks/final/fraud-detection-analysis.ipynb`, cells 80-82.
...
`notebooks/final/fraud-detection-analysis.ipynb`, cells 84 and 108; `report/master-thesis-es.pdf`, p. 61.
...
`notebooks/final/fraud-detection-analysis.ipynb`, cells 68-70, 93, and 117; `report/master-thesis-es.pdf`,
pp. 62-63.
...
Source: `notebooks/final/fraud-detection-analysis.ipynb`, cells 25-28 and 105-125.
